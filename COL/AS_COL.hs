...
instance GetRange COL_SIG_ITEM where
  getRange x = case x of
    Constructor_items _ p -> p
    Observer_items _ p -> p
  rangeSpan x = case x of
    Constructor_items a b -> joinRanges [rangeSpan a, rangeSpan b]
    Observer_items a b -> joinRanges [rangeSpan a, rangeSpan b]
